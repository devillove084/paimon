...
/**
 * Single-thread benchmark for "sequential read" using OpenDALFileIO.
 *
 * <p>We pre-write a file in setup, then read it in the benchmark.
 */
...
@Fork(1)
@Threads(1)
public class OpenDALSequentialReadBenchmark {
    ...
    public static class BenchmarkState {
        ...
        public void setup() throws IOException {
            ...
            // 2) Path
            readPath = new Path("/opendal-bench/seq-read.bin");

            // 3) Pre-write a 1GB file for reading
